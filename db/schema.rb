...
ActiveRecord::Schema[8.0].define(version: 2025_07_19_085915) do
  ...
  create_table "streamers", force: :cascade do |t|
    ...
    t.bigint "donation_target_id"
    t.index ["donation_target_id"], name: "index_streamers_on_donation_target_id"
